    ...
    <div class="flex flex-col-reverse md:flex-row md:gap-12">
        ...
        <div class=" flex flex-col  p-5 w-full md:w-1/3 md:ml-8 text-center">
            ...
            <p class=" text-justify mt-2 text-sm md:text-md">
                ...
                technology and expert support. With a team of professionals in design, development, and digital strategy, we
                deliver tailored Services that help clients grow, adapt, and succeed in the digital world.
            </p>
        </div>
        <!-- Right Section (Info Columns) -->
        <div class="w-full md:w-1/2 ml-8 flex text-center md:text-left">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 p-5 sm:p-8 md:p-10">
                <!-- Services -->
                <div class="">
                ...
                <!-- Contact Info -->
                <div class="flex flex-col gap-3 cursor-pointer text-center md:text-left">
