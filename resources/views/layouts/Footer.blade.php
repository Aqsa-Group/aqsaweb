...
<div class="bg-[#235F7F] mt-24 w-full text-white" >
    <div class="flex flex-col-reverse md:flex-row md:gap-12">
        ...
        <div class=" flex flex-col p-5 w-full md:w-1/3 md:ml-8 text-center">
            <div class="flex flex-row gap-2 justify-center  mx-4 bg-white h-auto rounded-lg md:rounded-xl py-1 md:mt-4">
                <div>
            ...
            <p class=" text-justify mt-2 text-sm md:text-md mx-4">
        ...
        <div class="w-full md:w-1/2 ml-8 fnjlonhlex text-center md:text-left">
