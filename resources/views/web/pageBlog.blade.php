         ...
         <main>
            ...
            <div class="px-8">
                ...
                <div class="sm:mt-4 mt-24">
                    <h1 class="font-bold text-2xl">Page/ Our Blog</h1>
                </div>
                ...
                <form action="#">
                    <div class="pb-6">
                        ...
                        <div class="md:mx-32 px-4">
                            ...
                            <button class="input-btn relative mx-auto sm:w-[250px] w-[100%] h-[45px] border-2 border-[#235F7F] outline-none rounded-3xl cursor-pointer text-lg font-semibold flex items-center justify-center overflow-hidden">
