...
<body class="bg-gray-100 flex h-screen">
        ...
        <div class='cursor-pointer relative'>
            ...
            <div class='content lg:ml-5 sm:ml-4 ml-5 w-full mt-0 p-2 hidden text-gray-700'>
                <ul>
                    <li>
                        <a href={{ url('/pageHome') }}
                        class='inline-block hover:ml-3 hover:text-[#235F7F] duration-300 transition-all ease-in w-full text-sm rounded-md p-2 hover:bg-[#235F7F]/20'
                    ...
                    <li>
                        ...
                        ><p class="lg:hidden sm:flex hidden text-[#235F7F]">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-white shadow-md flex justify-between items-center px-6 py-4">
      ...
      <h1 class="sm:flex hidden text-xl font-bold text-gray-800">Page/ About Us</h1>
    ...
    <main class="px-6 space-y-6 overflow-y-auto pb-7">
      ...
      <h1 class="flex mt-8 sm:hidden text-2xl font-bold text-gray-800">Page/ About Us</h1>
      <!-- Date & Time -->
      ...
      <!-- Page Form -->
        ...
        <div>
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Our History</h2>
            <!--  Title -->
            <div class="input-box">
                <label class="block mt-3 mx-2 font-medium text-gray-700">Title</label>
                <input id="myinput" type="text" 
                class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" 
                id="mainTitle" 
            ...
            <!-- Paragraph -->
            <div class="input-box">
                <label class="block mt-3 mx-2 font-medium text-gray-700">Paragraph</label>
                <textarea id="mainParagraph myinput" placeholder="Enter Paragraph" 
                class="w-full border border-gray-300 mt-2 p-2 rounded-lg focus:border-[#3084b1] text-black outline-none  px-5 py-2" rows="3"></textarea>
            </div>
        </div>
        ...
        <!-- Cards Section 1 -->
        <div>
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Core Values</h2>
            <!--  Title -->
            ...
            <div id="cardsContainer" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="border rounded-lg p-4 shadow input-box">
                    <label class="block font-medium m-2 text-gray-700">Card 1 Icon</label>
                ...
                <!-- Card 2 -->
                <div class="border rounded-lg p-4 shadow input-box">
                    <label class="block font-medium m-2 text-gray-700">Card 2 Icon</label>
                    <input type="file" id="cardImage1 myinput" accept="image/*"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                    <img id="previewCard1" class="mt-3 w-32 rounded-lg shadow hidden" alt="Preview" />
                ...
                <!-- Card 3 -->
                <div class="border rounded-lg p-4 shadow input-box">
                    <label class="block font-medium m-2 text-gray-700">Card 3 Icon</label>
                    <input type="file" id="cardImage1 myinput" accept="image/*"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                    <img id="previewCard1" class="mt-3 w-32 rounded-lg shadow hidden" alt="Preview" />
                ...
                <!-- Card 4 -->
                <div class="border rounded-lg p-4 shadow input-box">
                    <label class="block font-medium m-2 text-gray-700">Card 4 Icon</label>
                    <input type="file" id="cardImage1 myinput" accept="image/*"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                    <img id="previewCard1" class="mt-3 w-32 rounded-lg shadow hidden" alt="Preview" />
        ...
        <!-- Cards Section 2 -->
        <div>
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Team</h2>
            ...
            <div id="cardsContainer" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="border rounded-lg p-4 shadow input-box">
                    ...
                    <label class="block mt-4 m-1 font-medium text-gray-700">Card 1 Job</label>
                    <input type="text" id="cardTitle1 myinput" placeholder="Enter card title"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                ...
                <div class="border rounded-lg p-4 shadow input-box">
                    ...
                    <label class="block mt-4 m-1 font-medium text-gray-700">Card 2 Jab</label>
                    <input type="text" id="cardTitle1 myinput" placeholder="Enter card title"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                ...
                <div class="border rounded-lg p-4 shadow input-box">
                    ...
                    <label class="block mt-4 m-1 font-medium text-gray-700">Card 3 Jab</label>
                    <input type="text" id="cardTitle1 myinput" placeholder="Enter card title"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
                ...
                <div class="border rounded-lg p-4 shadow input-box">
                    ...
                    <label class="block mt-4 m-1 font-medium text-gray-700">Card 4 Jab</label>
                    <input type="text" id="cardTitle1 myinput" placeholder="Enter card title"
                    class="text-black focus:border-[#3084b1] outline-none border border-gray-300 rounded-lg px-5 py-2 w-full" />
