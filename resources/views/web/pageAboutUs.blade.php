         ...
         <main>
            ...
            <div class="px-8">
                ...
                <div class="sm:mt-4 mt-24">
                    <h1 class="font-bold text-2xl">Page/ About Us</h1>
                </div>
                ...
                <form action="#">
                    <div class="grid lg:grid-cols-3 grid-cols-1 lg:pb-0 pb-6">
                        ...
                        <div class="px-4">
                            ...
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <input id="myinput" class="w-[100%] h-[100%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" type="text">
                                <label class="absolute transition-all top-[50%] left-0 -translate-y-[50%] pointer-events-none" for="text">Change title our history</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change text our history</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] mt-7">
                                <input id="myinput" class="w-[100%] h-[100%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" type="text">
                                <label class="absolute transition-all top-[50%] left-0 -translate-y-[50%] pointer-events-none" for="text">Change title features</label>
                            </div>
                        </div>
                        ...
                        <div class="px-4">
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <input id="myinput" class="w-[100%] h-[100%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" type="text">
                                <label class="absolute transition-all top-[50%] left-0 -translate-y-[50%] pointer-events-none" for="text">Change text features</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <input id="myinput" class="w-[100%] h-[100%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" type="text">
                                <label class="absolute transition-all top-[50%] left-0 -translate-y-[50%] pointer-events-none" for="text">Change text button</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change first card title & text</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change second card title & text</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change thrid card title & text</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] mt-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change forth card title & text</label>
                            </div>
                        </div>
                        ...
                        <div class="px-4">
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <input id="myinput" class="w-[100%] h-[100%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" type="text">
                                <label class="absolute transition-all top-[50%] left-0 -translate-y-[50%] pointer-events-none" for="text">Change title our team</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change first card title & text</label>
                            ...
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change third card title & text</label>
                            </div>
                            <div class="input-box relative w-[100%] h-[50px] my-7">
                                <textarea id="myinput" name="message" class="w-[100%] h-[90%] bg-transparent outline-none focus:border-[#235F7F] border-b-2 border-[#000] text-lg font-medium pr-6" id=""></textarea>
                                <label class="absolute transition-all top-[35%] left-0 -translate-y-[65%] pointer-events-none" for="text">Change forth card title & text</label>
