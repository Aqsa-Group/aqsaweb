            ...
            <div class="grid gap-x-8 gap-y-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-9 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-xs font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-10 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Logistic" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-xs font-medium text-gray-800 hover:bg-gray-50">Logistic</button>
                            <button type="button" data-staff-select-option="ICT" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-xs font-medium text-gray-800 hover:bg-gray-50">ICT</button>
                        </div>
                    </details>
                </div>
                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-9 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-xs font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                            <span class="staff-select-value">Service</span>
                            <svg width="14" height="7" viewBox="0 0 14 7" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-10 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Service" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-xs font-medium text-gray-800 hover:bg-gray-50">Service</button>
                            <button type="button" data-staff-select-option="One Time" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-xs font-medium text-gray-800 hover:bg-gray-50">One Time</button>
                        </div>
                    </details>
                </div>
                ...
                <tbody>
                    @foreach ($contracts as $item)
                        <tr class="border-t border-gray-100">
                            ...
                            <td class="px-2 py-4">
                                <details class="staff-select relative inline-block min-w-[104px]">
                                    <summary class="flex h-8 cursor-pointer list-none items-center justify-between gap-2 rounded-lg border border-gray-200 bg-white px-2 text-[11px] font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                                        <span class="staff-select-value">{{ $item['status'] }}</span>
                                        <i class="fa-solid fa-chevron-down text-[9px] text-gray-500"></i>
                                    </summary>
                                    <div class="staff-select-menu absolute left-0 top-9 z-40 w-32 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                                        <button type="button" data-staff-select-option="{{ $item['status'] }}" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-[11px] font-medium text-gray-800 hover:bg-gray-50">{{ $item['status'] }}</button>
                                        <button type="button" data-staff-select-option="Approved" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-[11px] font-medium text-gray-800 hover:bg-gray-50">Approved</button>
                                        <button type="button" data-staff-select-option="Rejected" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-[11px] font-medium text-gray-800 hover:bg-gray-50">Rejected</button>
                                    </div>
                                </details>
                            </td>
...
<path d="M15.3113 12.8328C15.1638 15.0452 15.09 16.1514 14.3692 16.8258C13.6483 17.5002 12.5397 17.5002 10.3223 17.5002H9.67787C7.46054 17.5002 6.35187 17.5002 5.63103 16.8258C4.91019 16.1514 4.83644 15.0452 4.68895 12.8328L4.30566 7.0835M15.6946 7.0835L15.5279 9.5835" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-950">{{ $item['amount'] }}</p>
                </div>

                <div>
                    <p class="text-gray-400">Net Receivable</p>
                    <p class="font-medium text-gray-950">{{ $item['net'] }}</p>
                </div>
            </div>
        </div>
    @endforeach
