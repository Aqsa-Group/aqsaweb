    ...
    <div class="rounded-xl bg-white">
            ...
            <table class="w-full table-fixed text-left text-xs">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 py-3 font-semibold text-gray-950">Vendor</th>
                ...
                <tbody>
                    @foreach ($purchases as $purchase)
                        <tr class="border-t border-gray-100 align-middle">
                            ...
                            <td class="px-2 py-4 font-medium">{{ $purchase['invoice'] }}</td>
                            <td class="px-2 py-4">{{ $purchase['vendor'] }}</td>
                            <td class="px-2 py-4">{{ $purchase['project'] }}</td>
                            <td class="px-2 py-4">
                                <span class="rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $purchase['company'] }}</span>
                            </td>
                            <td class="px-2 py-4">
                                <span class="rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $purchase['status'] }}</span>
                            </td>
                            <td class="px-2 py-4">{{ $purchase['total'] }}</td>
                            <td class="px-2 py-4">
                                <span class="rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $purchase['date'] }}</span>
                            </td>
        ...
        <div class="mt-5 flex flex-col gap-3 text-sm text-gray-500 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-3">
                @include('AdminDashboard.partials.staff-pagination', ['id' => 'purchase-invoices-rows-per-page'])
            </div>
        </div>
    </div>
</div>
