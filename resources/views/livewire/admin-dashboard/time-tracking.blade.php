                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-11 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                            <span class="staff-select-value">Non-Billable</span>
...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Non-Billable" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Non-Billable</button>
                            <button type="button" data-staff-select-option="Billable" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Billable</button>
                        </div>
                    </details>
                </div>
...
<path d="M6.66667 10.8333C6.66667 11.2936 6.29357 11.6667 5.83333 11.6667C5.3731 11.6667 5 11.2936 5 10.8333C5 10.3731 5.3731 10 5.83333 10C6.29357 10 6.66667 10.3731 6.66667 10.8333Z" fill="#1C274C"/>
                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-11 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                            <span class="staff-select-value">Submitted</span>
                            <svg width="14" height="7" viewBox="0 0 14 7" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                        </summary>
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Submitted" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Submitted</button>
                            ...
                            <button type="button" data-staff-select-option="Approved" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Approved</button>
                        </div>
                    </details>
                </div>
            </div>
            ...
            <table class="w-full table-fixed text-left text-xs">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Staff</th>
                        ...
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Hours</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Billable</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Rate</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Status</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Cost</th>
                ...
                <tbody>
                    @foreach ($timesheets as $item)
                        <tr class="border-t border-gray-100 align-middle">
                            ...
                            <td class="truncate whitespace-nowrap px-2 py-4 font-medium text-gray-900">{{ $item['staff'] }}</td>
                            ...
                            <td class="px-2 py-4">
                                <span class="inline-flex whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px] leading-5">
                                    {{ $item['date'] }}
                                </span>
                            </td>

                            <td class="truncate whitespace-nowrap px-2 py-4">{{ $item['hours'] }}</td>

                            <td class="px-2 py-4">
                                <span class="inline-flex max-w-full truncate whitespace-nowrap rounded-md border border-green-500 bg-green-50 px-2 py-0.5 text-[11px] text-green-700">
                                    {{ $item['billable'] }}
                                </span>
                            </td>

                            <td class="truncate whitespace-nowrap px-2 py-4">{{ $item['rate'] }}</td>

                            <td class="px-2 py-4">
                                <span class="inline-flex max-w-full truncate whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">
                                    {{ $item['status'] }}
                                </span>
                            </td>

                            <td class="truncate whitespace-nowrap px-2 py-4">{{ $item['cost'] }}</td>
...
<path d="M15.3113 12.8328C15.1638 15.0452 15.09 16.1514 14.3692 16.8258C13.6483 17.5002 12.5397 17.5002 10.3223 17.5002H9.67787C7.46054 17.5002 6.35187 17.5002 5.63103 16.8258C4.91019 16.1514 4.83644 15.0452 4.68895 12.8328L4.30566 7.0835M15.6946 7.0835L15.5279 9.5835" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-950">{{ $item['cost'] }}</p>
                </div>
            </div>
        </div>
    @endforeach
