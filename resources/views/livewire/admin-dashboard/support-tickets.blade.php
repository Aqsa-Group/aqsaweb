        ...
        <div class="space-y-5">
            ...
            <div class="grid gap-x-8 gap-y-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-11 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                            <span class="staff-select-value">Urgent</span>
...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Urgent" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Urgent</button>
                            <button type="button" data-staff-select-option="High" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">High</button>
                            <button type="button" data-staff-select-option="Normal" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Normal</button>
                            <button type="button" data-staff-select-option="Low" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Low</button>
                        </div>
                    </details>
                </div>
                ...
                <div>
                    ...
                    <details class="staff-select relative">
                        <summary class="flex h-11 cursor-pointer list-none items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-800 shadow-sm outline-none hover:bg-gray-50">
                            <span class="staff-select-value">Open</span>
                            <svg width="14" height="7" viewBox="0 0 14 7" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Open" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Open</button>
                            ...
                            <button type="button" data-staff-select-option="Resolved" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Resolved</button>
                        </div>
                    </details>
                </div>
...
<path d="M11.668 18.3334H8.33463C5.19194 18.3334 3.62059 18.3334 2.64428 17.3571C1.66797 16.3808 1.66797 14.8094 1.66797 11.6667V10C1.66797 6.85734 1.66797 5.286 2.64428 4.30968C3.62059 3.33337 5.19194 3.33337 8.33464 3.33337H11.668C14.8107 3.33337 16.382 3.33337 17.3583 4.30968C18.3346 5.286 18.3346 6.85734 18.3346 10V11.6667C18.3346 14.8094 18.3346 16.3808 17.3583 17.3571C16.814 17.9014 16.0847 18.1422 15.0013 18.2488" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
<path d="M5.83203 3.33337V2.08337" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
<path d="M14.168 3.33337V2.08337" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
<path d="M17.918 7.5H13.8555H8.95964M1.66797 7.5H4.89714" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
<path d="M14.9987 14.1667C14.9987 14.6269 14.6256 15 14.1654 15C13.7051 15 13.332 14.6269 13.332 14.1667C13.332 13.7064 13.7051 13.3333 14.1654 13.3333C14.6256 13.3333 14.9987 13.7064 14.9987 14.1667Z" fill="#1C274C"/>
<path d="M14.9987 10.8333C14.9987 11.2936 14.6256 11.6667 14.1654 11.6667C13.7051 11.6667 13.332 11.2936 13.332 10.8333C13.332 10.3731 13.7051 10 14.1654 10C14.6256 10 14.9987 10.3731 14.9987 10.8333Z" fill="#1C274C"/>
<path d="M10.8346 14.1667C10.8346 14.6269 10.4615 15 10.0013 15C9.54106 15 9.16797 14.6269 9.16797 14.1667C9.16797 13.7064 9.54106 13.3333 10.0013 13.3333C10.4615 13.3333 10.8346 13.7064 10.8346 14.1667Z" fill="#1C274C"/>
<path d="M10.8346 10.8333C10.8346 11.2936 10.4615 11.6667 10.0013 11.6667C9.54106 11.6667 9.16797 11.2936 9.16797 10.8333C9.16797 10.3731 9.54106 10 10.0013 10C10.4615 10 10.8346 10.3731 10.8346 10.8333Z" fill="#1C274C"/>
...
<path d="M5.97823 8.72119C5.78466 8.52755 5.78462 8.21363 5.97823 8.02002C6.17186 7.82661 6.48583 7.82651 6.67941 8.02002L8.45773 9.79834L8.45773 0.495605C8.45787 0.221884 8.68007 0.000488281 8.95382 0.000488281C9.22751 0.000564575 9.44977 0.221931 9.44991 0.495605L9.44991 9.79834L11.2282 8.02002C11.4219 7.82661 11.7358 7.82651 11.9294 8.02002C12.123 8.21359 12.1228 8.52754 11.9294 8.72119L9.30441 11.3462C9.11077 11.5398 8.79687 11.5398 8.60323 11.3462L5.97823 8.72119ZM0.145226 3.47119C-0.0484087 3.27756 -0.0484087 2.96365 0.145226 2.77002L2.77023 0.14502C2.96389 -0.0482531 3.27788 -0.0484953 3.4714 0.14502L6.0964 2.77002C6.28981 2.96354 6.28964 3.27756 6.0964 3.47119C5.9028 3.66479 5.58887 3.66472 5.39523 3.47119L3.61593 1.69287L3.61593 10.9956C3.61593 11.2693 3.39444 11.4914 3.12081 11.4917C2.84697 11.4917 2.62472 11.2694 2.62472 10.9956L2.62472 1.69287L0.846398 3.47119C0.652797 3.66479 0.33887 3.66472 0.145226 3.47119Z" fill="#71717A"/>
                ...
                <button wire:click="toggleForm"
                    class="inline-flex h-10 w-full items-center justify-center gap-2 rounded-md bg-[#2059D4] px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-800 sm:w-auto">
                ...
                <tbody>
                    @foreach ($tickets as $ticket)
                        <tr class="border-t border-gray-100 align-middle">
                            ...
                            <td class="px-2 py-4">
                                <span class="inline-flex whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $ticket['company'] }}</span>
                            </td>
                            <td class="px-2 py-4">
                                <span class="inline-flex whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $ticket['date'] }}</span>
                            </td>
...
<path d="M15.3113 12.8328C15.1638 15.0452 15.09 16.1514 14.3692 16.8258C13.6483 17.5002 12.5397 17.5002 10.3223 17.5002H9.67787C7.46054 17.5002 6.35187 17.5002 5.63103 16.8258C4.91019 16.1514 4.83644 15.0452 4.68895 12.8328L4.30566 7.0835M15.6946 7.0835L15.5279 9.5835" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <div class="mb-3 flex flex-wrap gap-2">
                ...
                <span class="rounded-md border border-red-300 bg-red-50 px-2 py-1 text-xs text-red-600">
                    {{ $ticket['priority'] }}
                </span>
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
                <div>
                    ...
                    <p class="font-medium text-gray-900">{{ $ticket['client'] }}</p>
                </div>

                <div>
                    <p class="text-gray-400">Date</p>
                    <p class="whitespace-nowrap font-medium text-gray-900">{{ $ticket['date'] }}</p>
                </div>
            </div>
        </div>
    @endforeach
