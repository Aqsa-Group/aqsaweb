...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Cash" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Cash</button>
                            <button type="button" data-staff-select-option="Bank Transfer" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Bank Transfer</button>
                        </div>
                    </details>
                </div>
...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="Office Rent" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Office Rent</button>
                            <button type="button" data-staff-select-option="Internet" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Internet</button>
                            <button type="button" data-staff-select-option="Fuel" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Fuel</button>
                            <button type="button" data-staff-select-option="Market Expenses" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Market Expenses</button>
                            <button type="button" data-staff-select-option="License renewal" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">License renewal</button>
                            <button type="button" data-staff-select-option="Bank fees" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">Bank fees</button>
                        </div>
                    </details>
                </div>
...
<path d="M12.4167 0.75L6.58333 5.75L5.125 4.5M0.75 0.749999L2.69444 2.41667" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="staff-select-menu absolute left-0 right-0 top-12 z-40 rounded-xl border border-gray-200 bg-white p-1.5 shadow-xl shadow-gray-200/70">
                            <button type="button" data-staff-select-option="USD" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">USD</button>
                            <button type="button" data-staff-select-option="AFN" class="flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium text-gray-800 hover:bg-gray-50">AFN</button>
                        </div>
                    </details>
                </div>
            ...
            <table class="w-full table-fixed text-left text-xs">
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Title</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Category</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Company</th>
                        <th class="whitespace-nowrap px-2 py-3 font-semibold text-gray-950">Source</th>
                ...
                <tbody>
                    @foreach ($expenses as $expense)
                        <tr class="border-t border-gray-100 align-middle">
                            ...
                            <td class="truncate whitespace-nowrap px-2 py-4 font-medium text-gray-900">{{ $expense['title'] }}</td>
                            <td class="truncate whitespace-nowrap px-2 py-4 text-gray-700">{{ $expense['category'] }}</td>
                            <td class="px-2 py-4">
                                <span class="inline-flex max-w-full truncate whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $expense['company'] }}</span>
                            </td>
                            <td class="truncate whitespace-nowrap px-2 py-4 text-gray-700">{{ $expense['source'] }}</td>
                            <td class="px-2 py-4">
                                <span class="inline-flex max-w-full truncate whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px]">{{ $expense['status'] }}</span>
                            </td>
                            <td class="truncate whitespace-nowrap px-2 py-4">{{ $expense['amount'] }}</td>
                            <td class="px-2 py-4">
                                <span class="inline-flex whitespace-nowrap rounded-md border border-gray-200 px-2 py-0.5 text-[11px] leading-5">{{ $expense['date'] }}</span>
                            </td>
