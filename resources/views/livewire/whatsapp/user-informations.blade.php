<div class="min-h-screen bg-gray-100 py-4 sm:py-8">
    <div class="max-w-7xl mx-auto px-2 sm:px-4">
        ...
        @if (session()->has('message'))
            <div class="bg-green-50 border-r-4 border-green-500 text-green-700 px-4 py-3 rounded-md mb-6 flex items-center justify-between"
                x-data="{ show: true }" x-show="show" x-transition>
                <span class="text-sm sm:text-base">{{ session('message') }}</span>
                <button @click="show = false" class="text-green-700 hover:text-green-900 mr-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
            ...
            <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text" wire:model="business_name"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-black focus:border-black transition"
                    ...
                    <!-- Business Type -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">نوع کسب و کار</label>
                        <select wire:model="business_type"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-black focus:border-black transition bg-white">
                    ...
                    <!-- Category -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">دسته‌بندی</label>
                    ...
                    <!-- Contact Person -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">شخص تماس</label>
                    ...
                    <!-- WhatsApp Number -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">شماره واتساپ</label>
                        <input type="text" wire:model="whatsapp_number"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm dir-ltr text-left focus:ring-2 focus:ring-black focus:border-black transition"
                            placeholder="مثال: 09123456789">
                    </div>

                    <!-- Phone Number -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">شماره تماس</label>
                    ...
                    <!-- Third Number -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">شماره سوم</label>
                    ...
                    <!-- City -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">شهر</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">آدرس</label>
                    ...
                    <div class="sm:col-span-2 lg:col-span-3">
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">توضیحات</label>
                ...
                <div class="mt-4 flex flex-col sm:flex-row gap-2 justify-end">
                    ...
                    @endif
                    <button type="submit"
                        class="bg-black hover:bg-gray-800 text-white px-6 py-2 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div class="relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search"
                    class="w-full pr-10 pl-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-black focus:border-black transition"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">کسب و کار</th>
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">نوع</th>
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">دسته‌بندی</th>
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">شخص تماس</th>
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">واتساپ</th>
                            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">شهر</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($informations as $information)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dir-ltr text-left">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-center">
                                    <div class="flex items-center justify-center gap-1">
                                        <button wire:click="edit({{ $information->id }})"
                                            class="text-gray-600 hover:text-black p-1.5 rounded hover:bg-gray-100 transition">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </button>
                                        <button wire:click="confirmDelete({{ $information->id }})"
                                            class="text-gray-600 hover:text-red-600 p-1.5 rounded hover:bg-gray-100 transition">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <span class="text-gray-500 text-sm">هیچ اطلاعاتی یافت نشد</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <div class="flex gap-1 mr-2">
                            <button wire:click="edit({{ $information->id }})"
                                class="text-gray-500 hover:text-black p-1.5 rounded hover:bg-gray-100 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </button>
                            <button wire:click="confirmDelete({{ $information->id }})"
                                class="text-gray-500 hover:text-red-600 p-1.5 rounded hover:bg-gray-100 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                </svg>
                            </button>
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex gap-3 justify-center">
                                ...
                                <button wire:click="cancelDelete"
                                    class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2 rounded-lg text-sm font-medium transition">
                                    انصراف
                                </button>
                            </div>
                        </div>
