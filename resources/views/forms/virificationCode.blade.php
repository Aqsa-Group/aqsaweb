    ...
    <div class="flex flex-row  w-[900px] h-[450px] rounded-lg shadow overflow-hidden mx-auto mt-32">
        ...
        <div class="w-1/2 bg-white flex flex-col justify-center px-10">
            ...
            <span  class="text-sm mt-2">
                Please enter your the code that we sent to your email.
            </span>
            <div class="mt-2 ">
                <label class="text-md  text-[#292D32]">Enter your code</label>
                <input type="text"
                        class="pl-10 py-2 mt-1 bg-transparent w-full rounded-md border border-gray-500 focus:border-[#185277] focus:outline-none" />
            </div>
            <!-- Button -->
            <button class="mt-4 py-2.5 rounded-md bg-gradient-to-r from-[#235F7F] to-[#3FABE5] w-full text-white ">
                Continue
            </button>
        </div>
    </div>
